...
function MarriageRegistration() {
    ...
    return (
        ...
        <div className="row justify-content-center box-height" >
            ...
            <div className="row justify-content-center p-2"><h2 style={{ textAlign:"center",fontFamily:'Verdana',fontWeight:'bold'}}>Marriage Registration Form</h2></div>
            <form className="form-inline" onSubmit={(e) => { handleSubmit(e) }}>
                ...
                <div className="border border-2 p-1" /* style={{backgroundColor:'teal'}} */>
                   <div className='row justify-content-center '> <h3 /* className='p-2 rounded'style={{ textAlign:"center",backgroundColor:"#3d5a80",width:"250px" }} */ style={{fontFamily:'Verdana',textAlign:"center"}}>Husband Details</h3></div>
                    ...
                    <div className="mb-3 row justify-content-center">
                        ...
                        <div className="col-sm-8">
                            <input type="text" className="form-control" name="wReligion" value={hReligion} required onChange={(e) => handleHReligionChange(e)} />
                        </div>
                    </div>
                    ...
                    <div className="mb-3 row justify-content-center">
                        ...
                        <div className="col-sm-8">
                            <input type="date" className="form-control" value={hDob} name="hDob" required onChange={(e) => { handleHDobChange(e) }} />
                        </div>
                    </div>
                    ...
                    <div className="mb-3 row justify-content-center">
                        ...
                        <div className="col-sm-8">
                            <input className="form-control" type="text" value={hAdderss} required onChange={(e) => { handleHAddressChange(e) }} />
                        </div>
                    </div>
                ...
                <div className='row justify-content-center '> <h3 className='p-2 rounded'style={{fontFamily:'Verdana',textAlign:"center"}}>Wife Details</h3></div>
                    <div className="mb-3 row justify-content-center">
                    ...
                    <div className="mb-3 row justify-content-center">
                        <label className="col-sm-3 col-form-label">Religion</label>
                        <div className="col-sm-8">
                            <input type="text" className="form-control" name="wReligion" value={wReligion} required onChange={(e) => handleWReligionChange(e)} />
                        </div>
                    </div>
                    ...
                    <div className="mb-3 row justify-content-center">
                        <label className="col-sm-3 col-form-label">Date of birth</label>
                        <div className="col-sm-8">
                            <input type="date" className="form-control" value={wDob} name="hDob" required onChange={(e) => { handleWDobChange(e) }} />
                        </div>
                    </div>
                    ...
                    <div className="mb-3 row justify-content-center">
                        <label className="col-sm-3 col-form-label">Marital status</label>
                        <div className="col-sm-8">
                            <select className="form-control" name="mStatus" required onChange={(e) => { handleWMStatusChange(e) }}>
                                <option value="select marital status" disabled selected>Select Marital Status</option>
                                <option value="bachelor">Bachelor</option>
                                <option value="widow">Widow</option>
                                <option value="divorcee">Divorcee</option>
                    ...
                    <div className="mb-3 row justify-content-center">
                        <label className="col-sm-3 col-form-label">Address</label>
                        <div className="col-sm-8">
                            <input className="form-control" type="text" value={wAdderss} required onChange={(e) => { handleWAddressChange(e) }} />
                        </div>
                    </div>
                    ...
                    <div className="mb-3 row justify-content-center">
                        <label className="col-sm-3 col-form-label">Id Number</label>
                        <div className="col-sm-8">
                            <input type="text" className="form-control" value={wIdNo} name="hIdNO" required onChange={(e) => { handleWIdNoChange(e) }} />
                        </div>
                    </div>
                ...
                <br/>
                <div className="border border-2 p-1" >
                <div className='row justify-content-center '> <h3 className='p-2 rounded'style={{fontFamily:'Verdana',textAlign:"center"}}>Witness 1 Details</h3></div>
                    <div className="mb-3 row justify-content-center">
                    ...
                    <div className="mb-3 row justify-content-center">
                        <label className="col-sm-3 col-form-label">Address</label>
                        <div className="col-sm-8">
                            <input className="form-control" type="text" value={w1Adderss} required onChange={(e) => { handleW1AddressChange(e) }} />
                        </div>
                    </div>
                    ...
                    <div className="mb-3 row justify-content-center">
                        <label className="col-sm-3 col-form-label">Id Number</label>
                        <div className="col-sm-8">
                            <input type="text" className="form-control" value={w1IdNo} name="hIdNO" required onChange={(e) => { handleW1IdNoChange(e) }} />
                        </div>
                    </div>
                ...
                <br/>
                <div className="border border-2 p-1">
                <div className='row justify-content-center '> <h3 className='p-2 rounded'style={{fontFamily:'Verdana',textAlign:"center"}}>Witness 2 Details</h3></div>
                    <div className="mb-3 row justify-content-center">
                        <label className="col-sm-3 col-form-label">Name:</label>
                        <div className="col-sm-8">
                    ...
                    <div className="mb-3 row justify-content-center">
                        <label className="col-sm-3 col-form-label">Address</label>
                        <div className="col-sm-8">
                            <input className="form-control" type="text" value={w2Adderss} required onChange={(e) => { handleW2AddressChange(e) }} />
                        </div>
                    </div>
                    ...
                    <div className="mb-3 row justify-content-center">
                        <label className="col-sm-3 col-form-label">Id Number</label>
                        <div className="col-sm-8">
                            <input type="text" className="form-control" value={w2IdNo} name="hIdNO" required onChange={(e) => { handleW2IdNoChange(e) }} />
                        </div>
                    </div>
