        ...
        <div className="row text-center g-4 ">
            ...
            <div className="col-md">
                <div className="card zoom bg-dark text-light"  >
                    <div className="card-body text-center" style={{backgroundColor:'teal'}}>
                        ...
                        <button onClick={(e) => birthRegistration(e)} className="btn btn-primary" style={{backgroundColor:'silver',color:'black',fontWeight:'bold'}}>Register</button>
            ...
            <div className="col-md">
                <div className="card zoom bg-dark text-light">
                    <div className="card-body text-center" style={{backgroundColor:'teal'}}>
                        ...
                        <button onClick={(e) => marriageRegistration(e)} className="btn btn-primary"  style={{backgroundColor:'silver',color:'black',fontWeight:'bold'}}>Register</button>
                    </div>
                </div>
            </div>
            ...
            <div className="col-md ">
                <div className="card zoom bg-dark text-light">
                    <div className="card-body text-center"  style={{backgroundColor:'teal'}}>
                        ...
                        <button onClick={(e) => deathRegistration(e)} className="btn btn-primary"  style={{backgroundColor:'silver',color:'black',fontWeight:'bold'}}>Register</button>
                    </div>
                </div>
