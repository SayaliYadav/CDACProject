    ...
    return (
        ...
        <div className="row justify-content-center box-height" >
            ...
            <div className="col-9 align-self-center shadow-lg" style={{ backgroundColor: '#ebf2fa' }} >
                <div className="row justify-content-center p-2"><h2 style={{fontFamily:'Verdana',textAlign:"center"}}>Death Registration Form</h2></div>
                <form className="form-inline" onSubmit={(e) => { handleSubmit(e) }}>
                    ...
                    <div className="border border-2 p-1">
                        ...
                        <div className="mb-3 row justify-content-center">
                            ...
                            <div className="col-sm-8">
                                <input type="radio"  id="female" name="gender" value="female" required onChange={(e) => { handleGenderChange(e) }} />Female  
                                <input type="radio"  id="male" name="gender" value="male" onChange={(e) => { handleGenderChange(e) }} />  Male
                            </div>
                        </div>
                        ...
                        <div className="mb-3 row justify-content-center">
                            ...
                            <div className="col-sm-8">
                                <input type="date" className="form-control" value={dob} name="dob" required onChange={(e) => { handleDobChange(e) }} />
                            </div>
                        </div>
