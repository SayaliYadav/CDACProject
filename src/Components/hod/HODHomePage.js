    ...
    return (
        <body>
            <div className='container-fluid'>
                ...
                {/* <!-- Showcase --> */}
                 <div><p className="lead my-6 slide-left" style={{fontFamily:'Verdana',fontWeight:'bold',fontSize:"34px"}}>
                                    Welcome to Mumbai Municipal Corporation
                                </p></div>
                {/* <img src={image} alt="" className="card-img" style={{height:"60vh"}}/>  */}
                ...
                {/* <section className="text-light p-5 p-lg-0 text-center text-sm-start"> */}
                    ...
                    <div className="container card-img-overlay">
                        <div className="d-sm-flex align-items-center justify-content-between">
                            <div>
                                <h1><span className="text-warning">Mumbai Municipal Corporation </span></h1>
                    ...
                    <div className="container">
                        <div className="row text-center g-4 my-4">
                            ...
                            <div className="col-md">
                                <div className="card zoom " style={{backgroundColor:'teal',color:"white"}}>
